...
| | |
|---|---|
| Latest tag | `v0.0.1-dev.1` |
| jsDelivr base | https://cdn.jsdelivr.net/gh/Digital-Woods/woodsportal-client-frontend-cdn@v0.0.1-dev.1/dist/cdn |
...
## jsDelivr URLs (tag `v0.0.1-dev.1`)
